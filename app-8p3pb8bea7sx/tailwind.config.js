    ...
    theme: {
        ...
        extend: {
            colors: {
                ...
                lingshan: {
                    green: 'hsl(var(--lingshan-green))',
                    'green-foreground': 'hsl(var(--lingshan-green-foreground))',
                    blue: 'hsl(var(--lingshan-blue))',
                    'blue-foreground': 'hsl(var(--lingshan-blue-foreground))',
                    gold: 'hsl(var(--lingshan-gold))',
                    'gold-foreground': 'hsl(var(--lingshan-gold-foreground))'
                },
                'data-highlight': {
                    DEFAULT: 'hsl(var(--data-highlight))',
                    foreground: 'hsl(var(--data-highlight-foreground))'
                }
            },
            borderRadius: {
                lg: 'var(--radius)',
